...
class Camera
  ...
  private void prepareMediaRecorder(String outputFilePath) throws IOException {
    ...
    if (Build.VERSION.SDK_INT >= 31) {
      mediaRecorderBuilder = new MediaRecorderBuilder(getRecordingProfile(), outputFilePath, cameraProperties);
    } else {
      mediaRecorderBuilder = new MediaRecorderBuilder(getRecordingProfileLegacy(), outputFilePath, cameraProperties);
    }
